...
public class ETLPipeline {
	public static void main(String[] args) {
		...
		// referenced from:
		// http://www.codebind.com/java-tutorials/java-example-read-file-using-java/
		...
		// referenced from:
		// https://www.geeksforgeeks.org/how-to-read-write-objects-data-in-csv-format-using-notepad-in-java/
