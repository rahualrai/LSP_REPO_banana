...
/**
 * The StreamingServiceDriver class demonstrates the usage of different media
 * types.
 */
public class StreamingServiceDriver {
	public static void main(String[] args) {
		...
		audiobookWithSpeed.setPlaybackSpeed(1.5); // Output: "Setting playback speed of audiobook: A Promised Land –
													// Barack Obama 1.5x"
		System.out.println();

		// Test Music-specific behavior (addToPlaylist)
		Music musicWithPlaylist = (Music) music; // Cast to Music for specific method
		musicWithPlaylist.addToPlaylist("Favorites"); // Output: "Added Still a Friend - Incognito to Favorites
														// playlist"
		System.out.println();
	}
}